    ...
    <section className="w-full bg-forest text-white py-24 md:py-32 px-6">
      <div className="max-w-[1000px] mx-auto flex flex-col items-center text-center">
        ...
        <AnimatedSection delay={200}>
          <div className="bg-white/5 border border-white/20 p-5 md:p-6 rounded-[24px] mb-10 max-w-2xl relative overflow-hidden group hover:bg-white/10 transition-colors duration-300">
