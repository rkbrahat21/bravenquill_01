  ...
  return (
    <section className="w-full bg-white pt-32 pb-16 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <div className="absolute top-[-20%] right-[-10%] w-200 h-200 bg-bloom rounded-full blur-[120px] opacity-60"></div>
        <div className="absolute bottom-0 left-[-10%] w-150 h-150 bg-celadon/20 rounded-full blur-[100px] opacity-60"></div>
      </div>
      ...
      <div className="max-w-300 mx-auto px-6 relative z-10">
        ...
        <AnimatedSection delay={300}>
          <div className="w-full bg-forest rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-linear-to-r from-emerald/10 to-transparent pointer-events-none"></div>
          </div>
        </AnimatedSection>
